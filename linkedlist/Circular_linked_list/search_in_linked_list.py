...
class CircularLinkedList:
    ...
    # def insert_at_position(self, data, position) + 1:
    ...
    def search(self, value):
        ...
        while True:
            current = current.next
            #search the value if the data is found return True
            if(current.data == value):
                return True
            #return false if loop is complete, and indicates no data is found
